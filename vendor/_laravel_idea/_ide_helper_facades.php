...
namespace BeyondCode\LaravelWebSockets\Facades {
    ...
    /**
     * @see \BeyondCode\LaravelWebSockets\Statistics\Logger\HttpStatisticsLogger::disconnection
     * @method static void disconnection(\Ratchet\ConnectionInterface $connection)
     * @see \BeyondCode\LaravelWebSockets\Statistics\Logger\HttpStatisticsLogger::apiMessage
     * @method static void apiMessage($appId)
     * @see \BeyondCode\LaravelWebSockets\Statistics\Logger\HttpStatisticsLogger::save
     * @method static void save()
     * @see \BeyondCode\LaravelWebSockets\Statistics\Logger\HttpStatisticsLogger::connection
     * @method static void connection(\Ratchet\ConnectionInterface $connection)
     * @see \BeyondCode\LaravelWebSockets\Statistics\Logger\HttpStatisticsLogger::webSocketMessage
     * @method static void webSocketMessage(\Ratchet\ConnectionInterface $connection)
     */
    class StatisticsLogger {}
    
    /**
     * @see \BeyondCode\LaravelWebSockets\Server\Router::customRoutes
     * @method static void customRoutes()
     * @see \BeyondCode\LaravelWebSockets\Server\Router::addRoute
     * @method static void addRoute(string $method, string $uri, $action)
     * @see \BeyondCode\LaravelWebSockets\Server\Router::echo
     * @method static void echo()
     * @see \BeyondCode\LaravelWebSockets\Server\Router::delete
     * @method static void delete(string $uri, $action)
     * @see \BeyondCode\LaravelWebSockets\Server\Router::getRoutes
     * @method static \Symfony\Component\Routing\RouteCollection getRoutes()
     * @see \BeyondCode\LaravelWebSockets\Server\Router::put
     * @method static void put(string $uri, $action)
     * @see \BeyondCode\LaravelWebSockets\Server\Router::patch
     * @method static void patch(string $uri, $action)
     * @see \BeyondCode\LaravelWebSockets\Server\Router::post
     * @method static void post(string $uri, $action)
     * @see \BeyondCode\LaravelWebSockets\Server\Router::webSocket
     * @method static void webSocket(string $uri, $action)
     * @see \BeyondCode\LaravelWebSockets\Server\Router::get
     * @method static void get(string $uri, $action)
     */
...
namespace Spatie\LaravelIgnition\Facades {
     ...
     * @method static null|\Spatie\FlareClient\Report report(\Throwable $throwable, callable $callback = null)
...
namespace {
    ...
    class WebSocketRouter extends BeyondCode\LaravelWebSockets\Facades\WebSocketRouter {}
}