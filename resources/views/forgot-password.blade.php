...
<div class="login-photo ml-auto mr-auto" style="max-width: 400px !important;">
    <div class="form-container">
        <form method="POST" action="{{ route('password.request') }}">
            ...
            <div class="form-group"><button class="btn btn-block btn-log" type="submit">Reset pssword</button></div><a class="already" href="/">You alredy have an account? Log in here.</a>
        </form>
         @if(session('status'))
